...
from ZenUI.component.scrollpanel.layer import ScrollPageBarLayer
from ZenUI.component.scrollpanel.handle import ScrollPageBarHandle
from ZenUI.core import Zen,ZColorSheet

class ScrollPageBar(ZWidget):
    """滚动面板的滚动条控件"""
    ...
    def _init_style(self):
        self._track = ScrollPageBarLayer(self)
        '轨道'
        self._handle = ScrollPageBarHandle(parent=self,
                                       width=10,
                                       height=20)
        '滑块'
        #设置样式
