...
from ZenUI._legacy.core import ZExpAnim,ZColorTool,Zen,AnimGroup,ZenGlobal
class ABCLabel(QLabel):
    ...
    def __init__(self,
        ...
        if image: self.setPixmap(image)
        if movie: self.setMovie(movie)
        if alignment: self.setAlignment(alignment.value)
