...
from ZenUI._legacy.component.button.widget import ButtonLayer
from ZenUI._legacy.core import ZExpAnim,AnimGroup,ZColorTool,ZenGlobal,Zen,ZSize,ZColorSheet,ZColors
class ABCToggleButton(QPushButton):
    ...
    def __init__(self,
        ...
        '闪烁层'
        self._indicator = ButtonLayer(self)
        '指示条'
