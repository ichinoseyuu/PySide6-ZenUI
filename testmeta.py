...
class Icon(AnimatedColorProperty):
    pass

class Text(AnimatedColorProperty):
    pass

class BackGround(AnimatedColorProperty):
    pass

class Border(AnimatedColorProperty):
    def __init__(self, parent: QWidget):
        super().__init__(parent)
        self._width: int = 1
...
class GradientBackGround(QObject):
    ...
    def __init__(self, parent: QWidget):
        ...
        self._type: GradientBackGround.Type = self.Type.Linear
        '渐变类型'
        self._direction: GradientBackGround.Direction = self.Direction.Diagonal
        '渐变方向'
