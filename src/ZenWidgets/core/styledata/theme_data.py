...
from ZenWidgets.core.conversion import ColorConverter
...
__all__ = [
    'ACCENT_COLOR_LIGHT',
    'ACCENT_COLOR_DARK',
    'FRAMELESS_THEME_DATA',
    'TRANSLUCENT_THEME_DATA'
    ]

ACCENT_COLOR_LIGHT: str = '#38b9f2'
ACCENT_COLOR_DARK: str = '#955595'

# region FRAMELESS_DARK
FRAMELESS_DARK_THEME_DATA: Dict[str, Dict[str, Any]] = MappingProxyType({
    'ZItem': {
        K.Text: '#dcdcdc',
        K.Icon: '#dcdcdc',
        K.Body: '#00ffffff',
...
# region FRAMELESS_LIGHT
FRAMELESS_LIGHT_THEME_DATA: Dict[str, Dict[str, Any]] = MappingProxyType({
    'ZItem': {
        K.Text: '#333333',
        K.Icon: '#555555',
        K.Body: '#00000000',
...
FRAMELESS_THEME_DATA = {
    'Dark': FRAMELESS_DARK_THEME_DATA,
    'Light': FRAMELESS_LIGHT_THEME_DATA
}

# region TRANSLUCENT_DARK
TRANSLUCENT_DARK_THEME_DATA: Dict[str, Dict[str, Any]] = MappingProxyType({
    'ZItem': {
        K.Text: '#dcdcdc',
        K.Icon: '#dcdcdc',
        K.Body: '#00ffffff',
    ...
    'ZSwitch':{
        K.Body: ColorConverter.trans(ACCENT_COLOR_DARK, 15),
        K.Border: '#90909090',
        K.Handle: '#bcbcbc',
        K.HandleToggled: '#bfbfbf'
    },
    'ZLineEdit': {
        ...
        K.UnderlineFocused: ACCENT_COLOR_DARK,
        K.Body: '#902d2d2d',
        K.BodyHover: '#90323232',
        K.BodyFocused: '#901f1f1f',
        K.Border: '#90323232',
        K.Radius: 5.0
    },
    'ZHeadLine':{
    ...
    'ZScrollPanel': {
        ...
        K.Border: '#601d1d1d',
        K.Handle: "#60454545",
        K.HandleBorder: '#604d4d4d',
        K.Radius: 5.0
    },
    'ZSlider': {
        K.Track: '#90464646',
        K.TrackBorder: '#90585858',
        K.FillAreaStart: ACCENT_COLOR_DARK,
        K.FillAreaEnd: ColorConverter.adjust(ACCENT_COLOR_DARK, 0.2),
        K.FillAreaBorder: ACCENT_COLOR_DARK,
        K.HandleInner: ColorConverter.adjust(ACCENT_COLOR_DARK, 0.2),
...
# region TRANSLUCENT_LIGHT
TRANSLUCENT_LIGHT_THEME_DATA: Dict[str, Dict[str, Any]] = MappingProxyType({
    'ZItem': {
        K.Text: '#333333',
        K.Icon: '#555555',
        K.Body: '#00000000',
    ...
    'ZSwitch':{
        K.Body: ColorConverter.trans(ACCENT_COLOR_LIGHT, 15),
        K.Border: '#90bfbfbf',
        K.Handle: '#909090',
        K.HandleToggled: '#f9f9f9'
    },
    'ZLineEdit': {
        ...
        K.UnderlineFocused: ACCENT_COLOR_LIGHT,
        K.Body: '#90f9f9f9',
        K.BodyHover: '#90f5f5f5',
        K.BodyFocused: '#90ffffff',
        K.Border: '#90dee2e6',
        K.Radius: 3.0
    },
    'ZHeadLine':{
    ...
    'ZScrollPanel': {
        ...
        K.Border: '#60e5e5e5',
        K.Handle: "#60cfcfcf",
        K.HandleBorder: '#60cdcdcd',
        K.Radius: 5.0
    },
    'ZSlider': {
        K.Track: '#90e5e5e5',
        K.TrackBorder: '#90d8d8d8',
        K.FillAreaStart: ACCENT_COLOR_LIGHT,
        K.FillAreaEnd: ColorConverter.adjust(ACCENT_COLOR_LIGHT, 0.2),
        K.FillAreaBorder: ACCENT_COLOR_LIGHT,
        K.HandleInner: ColorConverter.adjust(ACCENT_COLOR_LIGHT, 0.2),
    ...
    ('ZButton', 'ZComboBox'): {
        ...
        K.Icon: '#333333',
        K.Body: '#90ffffff',
        K.BodyHover: '#90f2f2f2',
        K.BodyPressed: '#90ebebeb',
        K.Border: '#90dee2e6',
        K.Radius: 5.0
    },
    'ZToggleButton': {
...
TRANSLUCENT_THEME_DATA = {
    'Dark': TRANSLUCENT_DARK_THEME_DATA,
    'Light': TRANSLUCENT_LIGHT_THEME_DATA
}